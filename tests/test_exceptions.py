...
from freya.exceptions import (
    FreyaError, FreyaConfigError, ConfigFileError, ConfigSchemaError, ConfigValidationError,
    FreyaServiceError, ServiceUnavailableError, ServiceTimeoutError,
    AgentError, AgentInitializationError, AgentCommunicationError, AgentMessageError, AgentCleanupError,
    ToolError, ToolNotFoundError, ToolExecutionError, ToolPermissionError, ToolNetworkError, ToolInputError,
    FreyaMemoryError, MemoryStorageError, MemoryQueryError, MemoryConnectionError,
    TTSError, TTSBackendError, TTSHardwareError, TTSAPIError, TTSVoiceNotFoundError,
    STTError, STTBackendError, STTHardwareError, STTAudioError,
    HotkeyError, HotkeyRegistrationError, HotkeyUnregistrationError,
)
...
class TestLegacyCompatibility:
    ...
    def test_legacy_exceptions_exist(self):
        ...
        from freya.exceptions import (
            OllamaError, WebSearchError, TextToSpeechError, SpeechToTextError,
            WakeWordDetectorError, FaceRecognitionError
        )
