...
class AudioChannelManager:
    ...
    async def start(self) -> None:
        ...
        logger.info("AudioChannelManager started with channels: %s", 
    ...
    async def register_channel(
        ...
        logger.info(
            ...
            channel_id, rule.priority, rule.exclusive,
        )
        ...
        if requesting_rule.priority > active_rule.priority:
            ...
            if active_rule.allow_interruption:
                logger.info(
                    ...
                    requesting_channel, active_channel,
                    requesting_rule.priority, active_rule.priority,
                )
            ...
            logger.info(
                ...
                requesting_channel, requesting_rule.priority,
                active_rule.priority, active_channel,
            )
            await self._publish_routing_decision(
                requesting_channel,
                action="queued",
    ...
    async def _handle_speech_error(self, message: Message) -> None:
        ...
        if activity.error_count >= self.error_threshold:
            ...
            logger.error(
                ...
                channel_id, activity.error_count,
            )
    ...
    def get_channel_status(self) -> dict[str, dict]:
        ...
        return {
            channel_id: {
                ...
                "last_wake": activity.last_wake_time.isoformat() if activity.last_wake_time else None,
            }
